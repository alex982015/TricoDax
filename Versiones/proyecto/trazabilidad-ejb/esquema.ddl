...
CREATE TABLE CUENTAFINTECH (IBAN BIGINT NOT NULL, CLASIFICACION BOOLEAN, ESTADO BOOLEAN NOT NULL, FECHAAPERTURA DATE NOT NULL, FECHACIERRE DATE, CLIENTE_ID BIGINT, COMISION DOUBLE, REFERENCIADA_IBAN BIGINT, PRIMARY KEY (IBAN))
CREATE TABLE CUENTAREF (IBAN BIGINT NOT NULL, NOMBREBANCO VARCHAR NOT NULL, PAIS VARCHAR, SALDO DOUBLE NOT NULL, SUCURSAL INTEGER, ESTADO BOOLEAN, FECHAAPERTURA DATE, PRIMARY KEY (IBAN))
...
CREATE TABLE PERSAUT (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, BLOQUEO BOOLEAN NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO BOOLEAN, FECHAFIN DATE, FECHAINICIO DATE, FECHANAC DATE, IDENT BIGINT NOT NULL, NOMBRE VARCHAR NOT NULL, USUARIOAUTAPK_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE Monedas (IBAN BIGINT, Moneda VARCHAR)
...
ALTER TABLE CUENTAFINTECH ADD CONSTRAINT FK_CUENTAFINTECH_REFERENCIADA_IBAN FOREIGN KEY (REFERENCIADA_IBAN) REFERENCES CUENTA (IBAN)
...
ALTER TABLE Monedas ADD CONSTRAINT FK_Monedas_IBAN FOREIGN KEY (IBAN) REFERENCES CUENTA (IBAN)
