...
CREATE TABLE INDIV (ID BIGINT NOT NULL, APELLIDO VARCHAR NOT NULL, FECHANACIMIENTO DATE, NOMBRE VARCHAR NOT NULL, PRIMARY KEY (ID))
CREATE TABLE PERSAUT (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, BLOQUEO BOOLEAN NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO BOOLEAN, FECHAFIN DATE, FECHAINICIO DATE, FECHANAC DATE, IDENT VARCHAR NOT NULL, NOMBRE VARCHAR NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE USERAPK (USUARIO VARCHAR NOT NULL, ADMINISTRATIVO BOOLEAN NOT NULL, PASSWORD VARCHAR NOT NULL, PERSONAAUTORIZADA_ID BIGINT, PERSONAINDIVIDUAL_ID BIGINT, PRIMARY KEY (USUARIO))
...
ALTER TABLE USERAPK ADD CONSTRAINT FK_USERAPK_PERSONAINDIVIDUAL_ID FOREIGN KEY (PERSONAINDIVIDUAL_ID) REFERENCES CLIENTE (ID)
ALTER TABLE USERAPK ADD CONSTRAINT FK_USERAPK_PERSONAAUTORIZADA_ID FOREIGN KEY (PERSONAAUTORIZADA_ID) REFERENCES PERSAUT (ID)
