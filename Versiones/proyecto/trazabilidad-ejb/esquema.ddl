...
CREATE TABLE PERSAUT (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO BOOLEAN, FECHAFIN DATE, FECHAINICIO DATE, FECHANAC DATE, IDENT BIGINT NOT NULL, NOMBRE VARCHAR NOT NULL, USUARIOAUTAPK_USUARIO VARCHAR, PRIMARY KEY (ID))
