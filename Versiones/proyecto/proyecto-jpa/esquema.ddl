...
CREATE TABLE CUENTA (IBAN BIGINT NOT NULL, TIPO VARCHAR(31), SWIFT VARCHAR, CLIENTE_ID BIGINT, CLASIFICACION BOOLEAN, ESTADO VARCHAR NOT NULL, FECHAAPERTURA DATE NOT NULL, FECHACIERRE DATE, NOMBREBANCO VARCHAR NOT NULL, PAIS VARCHAR, SALDO DOUBLE NOT NULL, SUCURSAL INTEGER, MONEDA_ABREVIATURA VARCHAR, COMISION DOUBLE, REFERENCIADA_IBAN BIGINT, PRIMARY KEY (IBAN))
CREATE TABLE CLIENTE (ID BIGINT NOT NULL, TIPO VARCHAR(31), CIUDAD VARCHAR NOT NULL, CODPOSTAL INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, FECHAALTA DATE NOT NULL, FECHABAJA DATE, IDENT BIGINT NOT NULL, PAIS VARCHAR NOT NULL, ESTADO BOOLEAN NOT NULL, TIPOCLIENTE VARCHAR NOT NULL, RAZONSOCIAL VARCHAR NOT NULL, APELLIDO VARCHAR NOT NULL, FECHANACIMIENTO DATE, NOMBRE VARCHAR NOT NULL, USUARIOAPK_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE USERAPK (USUARIO VARCHAR NOT NULL, AUTORIZADO BOOLEAN NOT NULL, PASSWORD VARCHAR NOT NULL, PRIMARY KEY (USUARIO))
