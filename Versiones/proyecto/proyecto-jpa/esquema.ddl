...
CREATE TABLE POOLEDACCOUNT (IBAN BIGINT NOT NULL, cuentaRef_IBAN BIGINT, SALDO DOUBLE, PRIMARY KEY (IBAN))
...
CREATE TABLE EMPRESA (ID BIGINT NOT NULL, RAZONSOCIAL VARCHAR, persAut_ID BIGINT, TIPO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE TRANS (ID BIGINT NOT NULL, CANTIDAD INTEGER, COMISION VARCHAR, FECHAEJECUCION DATE, FECHAINSTRUCCION DATE, INTERNACIONAL VARCHAR, TIPO VARCHAR, CUENTA_IBAN BIGINT, MONEDA_ABREVIATURA VARCHAR, TRANSACCION_IBAN BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE POOLEDACCOUNT ADD CONSTRAINT FK_POOLEDACCOUNT_cuentaRef_IBAN FOREIGN KEY (cuentaRef_IBAN) REFERENCES CUENTA (IBAN)
...
ALTER TABLE EMPRESA ADD CONSTRAINT FK_EMPRESA_persAut_ID FOREIGN KEY (persAut_ID) REFERENCES PERSAUT (ID)
...
ALTER TABLE TRANS ADD CONSTRAINT FK_TRANS_MONEDA_ABREVIATURA FOREIGN KEY (MONEDA_ABREVIATURA) REFERENCES DIVISA (ABREVIATURA)
